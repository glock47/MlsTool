...
class Collect_NbrAPI(Collect_Research_Data):
    ...
    def _update(self):
        ...
        expr = """se_num ~ FFI + FFI_ID + FFI_HD + FFI_ID_HD + ID + ID_HD + HD + pj_size + lg_num + age + cmmt_num + dev_num"""
        self.compute_nbr (cdf, expr, "se_num")
        print ("==================================== secutiry vulnerabilities ====================================")
        
        print ("==================================== Risky_resource_management ====================================")
        expr = """se_rem_num ~ FFI + FFI_ID + FFI_HD + FFI_ID_HD + ID + ID_HD + HD + pj_size + lg_num + age + cmmt_num + dev_num"""
        self.compute_nbr (cdf, expr, "se_rem_num")
        print ("==================================== Risky_resource_management ====================================")

        print ("==================================== Insecure_interaction_between_components ====================================")
        expr = """se_iibc_num ~ FFI + FFI_ID + FFI_HD + FFI_ID_HD + ID + ID_HD + HD + pj_size + lg_num + age + cmmt_num + dev_num"""
        self.compute_nbr (cdf, expr, "se_iibc_num")
        print ("==================================== Insecure_interaction_between_components ====================================")
       
        print ("==================================== Porous_defenses ====================================")
        expr = """se_pd_num ~ FFI + FFI_ID + FFI_HD + FFI_ID_HD + ID + ID_HD + HD + pj_size + lg_num + age + cmmt_num + dev_num"""
